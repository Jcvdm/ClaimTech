...
// Domain Type Aliases
// ============================================================================
// These aliases provide better type safety by using specific union types
// instead of generic strings for enum fields. Import these in your services
// instead of the raw Database['public']['Tables']['table_name']['Row'] types.
...
export type { Engineer } from './engineer';
export type { Inspection } from './inspection';
export type { Repairer } from './repairer';
export type { Request, RequestTask } from './request';
