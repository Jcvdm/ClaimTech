...
<body>
	...
	<div class="rates-section">
		<h3>LABOUR RATES</h3>
		<div class="info-row">
			<span class="info-label">Panel Rate:</span>
			<span class="info-value">${formatCurrency(estimate?.panel_rate || 0)} per hour</span>
		</div>
		<div class="info-row">
		...
		<div class="info-row">
			<span class="info-label">Mechanical Rate:</span>
			<span class="info-value">${formatCurrency(estimate?.mechanical_rate || 0)} per hour</span>
		</div>
	</div>
